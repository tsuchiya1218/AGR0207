...
@WebServlet("/Uc08_s1_08")
public class Uc08_s1_08 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<Integer> getToday = (ArrayList<Integer>) session.getAttribute("nowtime");
		...
		String shop = getAry2.get(1);
		String number = getAry2.get(2);
		String useTime = getAry2.get(3);
		String roomNum = r_id;
		...
		RequestDispatcher rd = request.getRequestDispatcher("uc08_s1_08.jsp");
