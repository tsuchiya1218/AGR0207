...
ArrayList<Integer> ary = (ArrayList<Integer>)session.getAttribute("ArrayList");
@SuppressWarnings("unchecked")
    ...
    <main>
		...
		<form method="post" name="form" action="">
			...
			<table class="time">
				<tr>
					<th rowspan="2">日時</th>
					<th colspan="7"><%=time.get(0)%>年<%=time.get(1)%>月</th>
				</tr>
				<tr class="dark">
					<%
			...
			<div class="click">
	            <button type="button" class="back" onclick="location.href='uc08_s1_02.jsp'">戻る</button>
