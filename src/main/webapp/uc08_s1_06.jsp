	...
	<main>
		...
		<form method="post" name="form" action="">
			<div class="apo">
				<p><%=ary1.get(1)%>
					<%=ary1.get(2)%>人
					<%=ary1.get(3)%>分 <%=ary2.get(0)%>月<%=ary2.get(1)%>日 <%=ary2.get(2)%>:<%=ary2.get(3)%>入室 <br>の検索結果
				</p>
				<table class="room">
					<tr>
						<th></th>
			...
			<div class="click">
				<button type="button" class="back" onclick="location.href='uc08_s1_04.jsp'">戻る</button>
				<button type="button" class="go" onclick="JumpJava08()">次へ</button>
			</div>
		</form>
	</main>
